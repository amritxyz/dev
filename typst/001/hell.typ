...
#align(center)[
  ...
  #text(weight: "bold")[Abstract] \
    Many people find it hard to keep track of their money. They often forget where they spent it or lose

    their notes. The Personal Expense Tracker is a simple tool that helps people record their

    income and expenses so they can better understand how they spend their money.

    With this app, users can add and organize their spending into categories like food, rent, or transport.

    hey can also see helpful charts and reports that show their spending habits each week or month.

    The app is easy to use and works on both computers and phones. It is built using common

    tools like React, Express-JS, and MySQL to keep everything safe and organized.

    This tracker makes it easier for anyone to manage their money, avoid overspending, and
