...
The design of the interface focuses on being clear, easy to navigate, and making key financial insights immediately accessible. It’s built to create a welcoming experience, so managing your money feels simple and not overwhelming [web:21][web:23].
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.2]{income_page.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.2]{expense_page.png}
